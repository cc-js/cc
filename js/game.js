$(function(){
    ...
    for(let i = 0;i<3;i++){
        ...
        if(i == 0){
            ...
            temp = '<img src="./img/roleimg/'+math+'.png">';
            $('.role_'+(i+1)).append(temp);
        }else{
	...
	function sendPoker (number){
		if(number < 17){
			...
			$('.all_poker li:last').animate({'left':'-500px','top':number*18+'px'},10, function(){
				...
				// 把牌发给中间玩家
				$('.all_poker li:last').animate({'left':number*30+'px','top':'500px'}, 10, function(){
					...
					// 把牌发给右边玩家
					$('.all_poker li:last').animate({'left':'700px', 'top':number*18+'px'}, 10, function(){
